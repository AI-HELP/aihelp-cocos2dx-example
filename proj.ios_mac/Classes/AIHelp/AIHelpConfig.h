...
private:
    ...
    bool isSyncCrmInfo;
public:
    UserConfig(string userId, string userName, string serverId, string userTags, string customData, bool isSyncCrmInfo);
    string getUserId();
    string getUserName();
    string getServerId();
    string getUserTags();
...
public:
    ...
    UserConfigBuilder setUserId(string userId);
    UserConfigBuilder setUserName(string userName);
    UserConfigBuilder setServerId(string serverId);
    UserConfigBuilder setUserTags(string userTags);
    UserConfigBuilder setCustomData(string customData);
    UserConfigBuilder setIsSyncCrmInfo(bool isSyncCrmInfo);
    UserConfig build();
};
